...
func NewColorDaceEffect(space *PixelSpace) *ColorDaceEffect {
	return &ColorDaceEffect{
		space:   space,
		circles: make(map[float64]*Circle),
	}
}

func (e *ColorDaceEffect) Render(midiState *midi.MidiState, t float64) {
